 ...
 * @author geverson
 */
public class ViewSobre extends JDialog implements ActionListener {
    ...
    private ImageIcon iiConfirmaDesenvolvedor, iiConfirmaSistema;
    ...
    public void sobreSistema() {
        ...
        this.jtaSobreSistema = new JTextArea("Nome do sistema: SisCV - Sistema de Controle de Vendas"
        ...
        this.iiConfirmaSistema = new ImageIcon(getClass().getResource("/img/button_confirmar.png"));
        this.jbConfirmaSistema.setIcon(iiConfirmaSistema);
    ...
    public void sobreDesenvolvedor() {
        ...
        this.iiConfirmaDesenvolvedor = new ImageIcon(getClass().getResource("/img/button_confirmar.png"));
        this.jbConfirmaDesenvolvedor.setIcon(iiConfirmaDesenvolvedor);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == jbConfirmaDesenvolvedor) {
            ...
            JOptionPane.showMessageDialog(null, "Nada implementado para esta ação.", "Ação negada", JOptionPane.WARNING_MESSAGE);
        }
    }
}
